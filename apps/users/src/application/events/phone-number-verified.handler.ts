...
import { PhoneNumberVerifiedIntegrationEvent } from '@app/contracts/events/users';
...
export class PhoneNumberVerfiedIntegrationEventHandler implements IEventHandler<PhoneNumberVerifiedDomainEvent> {
  public constructor(
    @Inject(LOGGER_PORT)
