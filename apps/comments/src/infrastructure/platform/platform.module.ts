...
@Module({
  ...
  providers: [
    ...
    { provide: INTEGRATION_EVENT_PUBLISHER_PORT, useClass: KafkaEventPublisherHandler },
    { provide: INTEGRATION_EVENT_CONSUMER_PORT, useClass: KafkaEventConsumerHandler },
